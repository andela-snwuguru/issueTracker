  ...
  class MaterialHtml
    ...
    def self.get_table_data(data,action_buttons)
      ...
      data.each{|items|
        ...
        if !action_buttons.empty?
          view_button = action_buttons['view'] ? "<a href='#{action_buttons['view']['url']}/#{items['id']}' title='View Item' id='#{action_buttons['view']['id']}'><i class='material-icons'>visibility</i></a>" : ''
          update_button = action_buttons['update'] ? "<a href='#{action_buttons['update']['url']}/#{items['id']}' title='Update Item' id='#{action_buttons['update']['id']}'><i class='material-icons'>input</i></a>" : ''
          delete_button = action_buttons['delete'] ? "<a href='#{action_buttons['delete']['url']}/#{items['id']}' title='Remove Item' id='#{action_buttons['delete']['id']}'><i class='material-icons'>delete</i></a>" : ''
